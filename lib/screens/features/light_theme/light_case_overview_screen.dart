...
class LightOverViewCaseDeskScreen extends StatefulWidget {
  const LightOverViewCaseDeskScreen({super.key});

  @override
  State<LightOverViewCaseDeskScreen> createState() =>
      _LightOverViewCaseDeskScreenState();
}

class _LightOverViewCaseDeskScreenState
    extends State<LightOverViewCaseDeskScreen> {
  String userName = "";
  String? userRole;
  String? _role;
  String? _phone;
            ...
            child: GradientTopLayout(
              child: SingleChildScrollView(
                ...
                padding: EdgeInsets.only(
                  ...
                  //     screenHeight *
                  //         0.04, // ❗ account for appbar + extra spacing
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: const [
                          BoxShadow(
                            ...
                            blurRadius: 12.5,
                            offset: Offset(0, 0), // matches CSS shadow
                          ),
                        ],
                      ),
                      child: Consumer<RemarksProvider>(
                        builder: (context, remarksProv, _) {
                          final bool hasRemarks =
                              remarksProv.remarks.isNotEmpty;
                          final bool loading = remarksProv.loading;
                          print(
                            "has remarks = $hasRemarks, loading = $loading",
                          );
                      ...
                      children: [
                        _gridCard(
                          ...
                          onTap: () {
                            ...
                            debugPrint("Ask your Lawyer tapped");
                          },
                        ),
                        _gridCard(
                          screenWidth: screenWidth,
          ...
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.outfit(
                ...
                fontWeight: FontWeight.w300,
                color: Color(0xFF2D2319).withOpacity(0.9),
                height: 1.3,
              ),
            ),
          ],
