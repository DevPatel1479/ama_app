...
class LightAskLaywerScreen extends StatefulWidget {
  const LightAskLaywerScreen({Key? key}) : super(key: key);

  @override
  State<LightAskLaywerScreen> createState() => _LightAskLaywerScreenState();
}

class _LightAskLaywerScreenState extends State<LightAskLaywerScreen> {
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            ...
                            top:
                                size.height * 0.04, // vertical padding from top
                            child: Container(
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 6), // spacing between text and line
                        /// ============================
                        /// UNDERLINE INDICATOR
                        /// ============================
                        Row(
