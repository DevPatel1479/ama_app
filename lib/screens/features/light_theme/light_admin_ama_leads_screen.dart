...
class LightAdminLeadsTabBar extends StatelessWidget {
  final int currentIndex;
  final ValueChanged<int> onChanged;

  const LightAdminLeadsTabBar({
    super.key,
...
class LightAdminAmaLeadsScreen extends StatefulWidget {
  const LightAdminAmaLeadsScreen({super.key});

  @override
  State<LightAdminAmaLeadsScreen> createState() =>
      _LightAdminAmaLeadsScreenState();
}

class _LightAdminAmaLeadsScreenState extends State<LightAdminAmaLeadsScreen> {
