        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Query Card (Text Field with gradient border)
              Container(
                width: screenWidth * 0.92, // ~400px
                height: screenHeight * 0.28, // ~228px
                padding: EdgeInsets.all(3), // thickness of the gradient border
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: const Color(0xFF2D2319), // solid background inside
              ...
              /// Submit Button
              SizedBox(
                width: screenWidth * 0.8, // ~362px
                height: screenHeight * 0.06, // ~50px
